...
const int sampleSize = 92; //Number of data points per gene (normally number of individuals from which data is collected, corresponds to columns in the expression data text file)
const int numberOfGenes = 100;// Number of distinct genes for which there is expression data (corresponds to rows in expression data)
